    ...
    >
      ...
      <Stack.Screen
        ...
        options={({ navigation: nav }) => ({
          title: "Arrangement Cases",
          headerLeft: () => (
            <AppBackButton onPress={() => nav.canGoBack() ? nav.goBack() : nav.navigate("ShopCenter")} />
          ),
        })}
      />
      ...
      <Stack.Screen name="ShopPaymentReceipt" component={FuneralShopPaymentReceiptScreen} options={{ headerShown: false }} />
      <Stack.Screen
        ...
        options={({ navigation: nav }) => ({
          ...
          headerLeft: () => (
            <AppHeaderBackButton onPress={() => nav.canGoBack() ? nav.goBack() : nav.navigate("ProfileMain")} />
          ),
        })}
      />
